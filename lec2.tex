...
\begin{itemize}
	...
	\]
	Let us try to compare the two curvatures. Given $s_i$ a frame of $E$, we consider the connection form $A=(A_i^{\;j})$ defined $\nabla s_i=A_i^{\;j}\otimes s_j$. Let $s^i$ be the dual frame of $E^\vee$. We obtain
	\begin{align*}
		d\langle s_i,s^j\rangle=0&=\langle \nabla s_i,s^j\rangle+\langle s_i,\nabla^\vee s^j\rangle\\
		&=\langle A_i^{\;k}\otimes s_k,s^j\rangle+\langle s_i,B^j_{\;k}\otimes s^k\rangle\\
		&=A_i^{\;j}+B^j_{\; i},
 	\end{align*}
...
\]
so that $K_X^n=\cO_X$. Hence, the power of the canonical bundle of a Kähler Calabi--Yau is always trivial.
\end{remark}
